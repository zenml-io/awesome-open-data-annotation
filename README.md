...
| [BIIGLE](https://github.com/biigle/biigle) | BIIGLE is a web application for the efficient and rapid annotation of still images and videos. ![](https://img.shields.io/github/stars/biigle/biigle?color=black&label=%E2%AD%90%EF%B8%8F&style=plastic) | GPL-3 |
...
| [LightlyStudio](https://github.com/lightly-ai/lightly-studio) | An open source tool to curate, annotate, and manage vision datasets (images and videos). Supports embedding-based auto-selection, annotation, and auto-labeling for bounding boxes, segmentation, and captions. ![](https://img.shields.io/github/stars/lightly-ai/lightly-studio?color=purple&label=%E2%AD%90%EF%B8%8F&style=plastic) | Apache-2 |
